...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210191618-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  start-mysqld --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Oct 19, 2022 16:18 EDT
# @@File             :  start-mysqld
# @@Description      :  script to start mysqld
...
HOSTNAME="${HOSTNAME:-casjaysdev-mysqld}"
...
SERVICE_COMMAND="mysqld --user=root --socket=/data/mysql/mysqld.sock --datadir=/data/mysql/db"
