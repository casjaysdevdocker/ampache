...
ARG BUILD_DATE="Sat Sep  2 01:51:00 PM EDT 2023"
...
ARG IMAGE_REPO="casjaysdevdocker/ampache"
...
ARG AMPACHE_FILENAME="ampache-${AMPACHE_VERSION}_all_php8.1.zip"

ARG PACK_LIST="bash mariadb-server-utils mariadb-client mariadb pwgen \
...
ENV HOSTNAME="casjaysdev-ampache"
...
RUN set -ex; \
  ...
  export AMPACHE_VERSION AMPACHE_FILENAME PHP_VERSION=$PHP_VERSION NODE_VERSION=$NODE_VERSION NODE_MANAGER=$NODE_MANAGER; \
  WWW_ROOT_DIR="${WWW_ROOT_DIR}" bash -c "$(curl -q -LSsf "https://github.com/templatemgr/ampache/raw/main/install.sh")"; \
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/ampache" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/ampache" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/ampache" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/ampache" \
